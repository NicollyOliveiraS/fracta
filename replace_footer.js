        ...
        <div class="max-w-7xl mx-auto px-6 py-8">
            <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                <div class="flex items-center gap-4">
                    <img src="__LOGO_PATH__" alt="Logo Fracta" class="w-24 h-auto object-contain">
                    <div class="h-6 w-[1px] bg-gray-200 hidden md:block"></div>
                    <p class="text-sm text-gray-500 font-medium hidden md:block">Plataforma de Aprendizado Interativo</p>
                </div>
                
                <div class="flex items-center gap-6 text-sm font-medium text-gray-500">
                    <a href="__AJUDA_PATH__" class="hover:text-amber-600 transition flex items-center gap-1.5">
                    ...
                    <a href="__CONFIG_PATH__" class="hover:text-amber-600 transition flex items-center gap-1.5">
            ...
            <div class="mt-8 pt-8 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-4">
                <p class="text-xs text-gray-400">© 2025 FRACTA. Todos os direitos reservados.</p>
                <div class="flex gap-4">
                    <a href="#" class="text-xs text-gray-400 hover:text-amber-600 transition">Termos de Uso</a>
                    <a href="#" class="text-xs text-gray-400 hover:text-amber-600 transition">Privacidade</a>
                </div>
            </div>
        </div>
    </footer>
